...
import { Account, ThemeMode } from '../types';
...
export const SearchableAccountPicker: React.FC<SearchableAccountPickerProps> = ({
  ...
  return (
    <div
      id="searchable-account-picker-backdrop"
    ...
    >
      <div
        id="searchable-account-picker-sheet"
      ...
      >
        ...
        <div className={`flex items-center justify-between px-5 pt-4 pb-3 border-b ${
          ...
          <div className="flex items-center gap-2">
            <div className={`p-2 rounded-xl ${isDark ? 'bg-teal-500/10 text-teal-400' : 'bg-teal-50 text-teal-600'}`}>
        ...
        <div className={`p-3.5 border-b ${isDark ? 'border-zinc-800 bg-zinc-950/40' : 'border-slate-100 bg-slate-50/50'}`}>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search accounts / vaults..."
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <span
                      className="w-4 h-4 rounded-full shrink-0 shadow-sm ring-2 ring-black/10"
                    ...
                    <div className="truncate">
                      ...
                      <div className={`text-xs ${isDark ? 'text-zinc-400' : 'text-slate-500'}`}>
                        Initial balance: {formatMoney(acc.initialBalance, currency)}
                      </div>
                    </div>
                  </div>
